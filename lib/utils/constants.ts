...
export const STAKING_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STAKING_CONTRACT || process.env.NEXT_PUBLIC_STAKING_ADDRESS || "0x50AB6B4C3a8f7377F424A0400CDc3724891A3103";
