...
- ✅ **Return Types**: Matched with contract implementation
...
### Staking Pools:
1. **Pool 0: Flexible** - 50% APY
2. **Pool 1: 30 Days** - 75% APY
3. **Pool 2: 90 Days** - 125% APY
4. **Pool 3: 180 Days** - 175% APY
5. **Pool 4: 365 Days** - 325% APY
...
5. **Test Referral**: Test referral system
...
2. ✅ `hooks/useStaking.ts` - ABI updated
